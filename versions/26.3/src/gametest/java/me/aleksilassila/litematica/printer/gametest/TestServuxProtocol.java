...
public final class TestServuxProtocol {
    ...
    private static void receive(
        ...
        if (packet.getType()
            ...
            // Litematica validates that the Servux implementation advertises the
            // running Minecraft version before enabling the authoritative path.
            metadata.putString("servux", "servux-fabric-26.3");
