...
final class QuickShulkerInventory {
    ...
    static int findInsertSlot(ItemStack box, ItemStack inserted) {
        ...
        // ItemContainerContents omits trailing empty slots. The next encoded
        // index is therefore the first possible empty slot; the server checks
        // it against the live (possibly mod-extended) shulker size.
        return slots.size();
    }
