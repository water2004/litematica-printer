...
public class ActionManager {
    ...
    public void setShift(LocalPlayer player, boolean shift) {
        // 1.21.1 uses the player-command packet for sneaking; input packets
        // only carry vehicle movement and do not update the server's sneak flag.
        ServerboundPlayerCommandPacket packet = new ServerboundPlayerCommandPacket(
                player, shift ? ServerboundPlayerCommandPacket.Action.PRESS_SHIFT_KEY
